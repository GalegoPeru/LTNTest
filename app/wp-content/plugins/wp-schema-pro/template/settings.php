									...
									<table class="form-table" >
										...
										<tr>
											...
											<select class = ' wp-select2 wpsp-setup-configuration-settings' name="wp-schema-pro-corporate-contact[contact-page-id]">
														<?php $post_title = get_the_title( $contact_settings['contact-page-id'] ); ?>
										...
										<tr>
											...
											<p style="font-style: italic;"><?php esc_html_e( 'Enter the international version of your contact phone number starting with the “+” sign and country code, e.g., +1 for the US and Canada. Example: +1-800-555-1212.', 'wp-schema-pro' ); ?></p></td>
										</tr>
											...
											<td>
												<select class = 'wp-select2 wpsp-setup-configuration-settings' name="wp-schema-pro-global-schemas[about-page]">
													<option value=""><?php esc_html_e( '--None--', 'wp-schema-pro' ); ?></option>
														<?php $post_title = get_the_title( $settings['about-page'] ); ?>
										...
										<tr>
											...
											<td>
												<select class = 'wp-select2 wpsp-setup-configuration-settings' name="wp-schema-pro-global-schemas[contact-page]">
														<?php $post_title = get_the_title( $settings['contact-page'] ); ?>
						...
						<div class="inside">
							<div>
								...
								if ( '' !== $settings['sp_plugin_name'] ) {
									...
									?>
								<p><?php esc_html_e( 'Not sure where to start? Check out our Initial Setup Wizard first.', 'wp-schema-pro' ); ?></p><?php } ?>
