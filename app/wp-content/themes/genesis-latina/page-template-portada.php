...
<div class="container container-home">
	...
	<!--<section class="destacada-single">
		<div class="marco-destacada">
		<span class="nav-left"><img  src="<?php echo get_stylesheet_directory_uri()?>/img/arrow_left.png" alt=""></span>
		
			<div class="carousel-destacada-single owl-carousel">
				<?php echo print_destacada_portada("destacada_1",7621)?>
				<?php echo print_destacada_portada("destacada_2",7621)?>
				<?php echo print_destacada_portada("destacada_3",7621)?>
			</div>
			<span  class="nav-right"><img  src="<?php echo get_stylesheet_directory_uri()?>/img/arrow_right.png" alt=""></span>
	...
	<div class="relative">
			<span class="nav-left-ultima">
				<img src="<?php echo get_stylesheet_directory_uri()?>/img/iconos/arrowleftblack.png">
			</span>
			<span class="nav-right-ultima">
				<img src="<?php echo get_stylesheet_directory_uri()?>/img/iconos/arrowrightblack.png">
			</span>
...
<div class="lyt-tempalte-bloque-1">
	<section class="list-news-section" id="new_lyt">
		<span class="title-info">Últimas noticias</span>
		<?php $ind=0;?>
